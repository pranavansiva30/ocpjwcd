...
void getconnection()
{
    try
    {
        ...
        con=DriverManager.getConnection ("jdbc.odbc:MyDB","hnd","hnd");
    }
   catch (Exception e)
   {
        ...
        try
        {
         ...
         PreparedStatement stat=con.prepareStatement
                 ...
                 ( " insert into [BookDetails] values (?,?,?)");
                              ...
                              stat.setString(1,txtinfo.getText());
                              stat.setString(1,TxtPrice.getText());
                              stat.executeUpdate();
        JOptionPane.showMessageDialog(null,new String("Data inserted"));
        }
        catch (Exception e)
        {
            JOptionPane.showMessageDialog(null,new String("Error   "+e));
